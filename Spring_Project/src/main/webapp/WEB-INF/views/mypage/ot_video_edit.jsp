...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"> 
	...
	<hr style="border:solid 1px #3A4CA8;" width="65%">
	<br>
  		 <h3 align="center"> 강의의 OT정보를 수정해주세요! </h3>
      ...
      <section>
        ...
        <div class="form-group" style="float: left">
          ...
          <div class="col-md-8 col-sm-9">
              ...
              <input type="text" class="form-control" name="ot_title" id="ottitle" placeholder="해당 클래스의 강의 목표를 입력해주세요." value="${dto.getOt_title() }" style="width: 700px;"> 
          	  </div>
            <br>
         ...
         <div class="form-group" style="float: left">
          ...
          <div class="col-md-8 col-sm-9">
              <div class="input-group">
              <textarea rows="7" cols="95" class="form-control" name="ot_notice" id="otnotice">${dto.getOt_notice() }</textarea>
          	  </div>
            <br>
        ...
        <div class="form-group">
          ...
          <div class="form-inline form-group">
              ...
              <input type="number" name="time_first_m" style='width:85px;' value="0" class="form-control"> 분 <input type="number" name="time_first_s" style='width:80px;' value="0" class="form-control">초 
          ...
          <div class="form-inline form-group">
          	  <label class="control-label col-sm-8" style="size: 15px">
              <input type="number" name="time_second_m" style='width:85px;' value="0" class="form-control"> 분 <input type="number" name="time_second_s" style='width:80px;' value="0" class="form-control">초 
          ...
          <div class="form-inline form-group">
          	  <label class="control-label col-sm-8" style="size: 15px">
              <input type="number" name="time_third_m" style='width:85px;' value="0" class="form-control"> 분 <input type="number" name="time_third_s" style='width:80px;' value="0" class="form-control">초 
            ...
            <div class="form-inline form-group">
               <label class="control-label col-sm-7" style="size: 15px"><button onclick="insertTr()" id="btn1" class="btn btn-info">추가</button></label>
          	</div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-8 col-sm-9">
            ...
            <a href="https://www.youtube.com" target="_blank">Youtube 바로가기</a> &nbsp;&nbsp;
            <button type="button" class="btn btn-default btn-ico" data-toggle="modal" data-target="#myModal">
                자세히보기
        	</button> 
          </div>
        </div>
        ...
        <div class="form-group">
          <div class="col-xs-offset-3 col-xs-10">
            <input name="submit" type="submit" value="OT등록" class="btn btn-primary">&nbsp;&nbsp;
            <button class="btn btn-warning" onclick="location.href='<%=request.getContextPath()%>/resist_ot_later.do'">나중에 등록</button>
